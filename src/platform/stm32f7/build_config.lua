...
function add_platform_configs( t, board, cpu )
  t.stm32f7_uart_pins = {
    attrs = {
      con_rx_port = at.int_attr( 'STM32F7_CON_RX_PORT', 0 ),
      con_rx_pin = at.int_attr( 'STM32F7_CON_RX_PIN', 0 ),
      con_tx_port = at.int_attr( 'STM32F7_CON_TX_PORT', 0 ),
      con_tx_pin = at.int_attr( 'STM32F7_CON_TX_PIN', 0 )
    },
    required = { con_rx_port = 0, con_rx_pin = 10, con_tx_port = 0, con_tx_pin = 9 }
  }
